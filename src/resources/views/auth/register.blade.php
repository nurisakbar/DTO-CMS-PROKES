                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @include('alert')
                                    <form class="user" method="POST" action="/register2">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input id="nim" placeholder="Nomor Induk Mahasiswa" type="text"
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Daftar Account</button>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-6">
